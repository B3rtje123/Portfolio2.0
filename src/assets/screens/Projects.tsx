        ...
        <main className="">
            ...
            <div className="container mx-auto px-8 font-light pt-16 md:px-20 md:pt-20">
                ...
                2xl:pt-8 relative">
                    ...
                    md:h-full
                    xl:-ml-56
                    2xl:skew-x-0 2xl:rounded-full 2xl:bg-yellow 2xl:shadow-2xl">
                        <img src={foto1} alt="" className="skew-x-12 ml-8 md:-mt-8 xl:ml-12 2xl:skew-x-0 2xl:ml-0" />
                    </div>
                    <div className="-skew-x-12">
                        <h2 className="pb-12 text-lg font-medium md:text-2xl xl:text-4xl 2xl:text-8xl">Jachtseizoen<span className="font-black text-yellow">.</span></h2>
                ...
                md:gap-24">
                    ...
                    <div className="z-10">
                        <h2 className="pb-12 text-lg font-medium md:text-2xl xl:text-4xl 2xl:text-8xl">'t goed ter Heule'<span className="font-black text-yellow">.</span></h2>
                        <p className="pb-2 text-sm md:text-lg xl:text-2xl 2xl:text-5xl">
                ...
                md:gap-24">
                    ...
                    xl:-ml-60
                    2xl:skew-x-0 2xl:rounded-full 2xl:shadow-2xl">
                        <img src={foto3} alt="" className="-scale-x-100 skew-x-12 ml-20 2xl:skew-x-0 2xl:ml-0" />
                    </div>

                    <div className="w-full z-10">
                        <h2 className="pb-4 text-lg font-medium md:text-2xl xl:text-4xl xl:pb-12 2xl:text-8xl">Spotify Add<span className="font-black text-yellow">.</span></h2>
